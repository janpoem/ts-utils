...
[@zenstone/ts-utils](../../modules.md) / [async](../README.md) / timeout

# Function: timeout()

> **timeout**\<`F`\>(`fn`, `ms`): (...`args`) => `Promise`\<`Awaited`\<`ReturnType`\<`F`\>\>\>

Defined in: [src/async/index.ts:231](https://github.com/janpoem/ts-utils/blob/a6181273044ad30164507cc181a58cccd8e952df/src/async/index.ts#L231)
