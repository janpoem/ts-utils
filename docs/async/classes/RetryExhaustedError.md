...
[@zenstone/ts-utils](../globals.md) / RetryExhaustedError

# Class: RetryExhaustedError

Defined in: src/async/index.ts:14
...
> **new RetryExhaustedError**(`originalError`, `attempts`): `RetryExhaustedError`

Defined in: src/async/index.ts:19
...
Defined in: src/async/index.ts:21
...
Defined in: src/async/index.ts:20
