...
| 模块 | 说明 | 导入路径 |
|------|------|----------|
| [`async`](_media/README.md) | 异步工具函数 | `@zenstone/ts-utils/async` |
| [`guards`](_media/README-1.md) | Type Guards 和基础类型工具 | `@zenstone/ts-utils/guards` |
| [`path`](_media/README-2.md) | 路径处理 | `@zenstone/ts-utils/path` |
| [`http`](_media/README-3.md) | HTTP 相关工具 | `@zenstone/ts-utils/http` |
| [`remote`](_media/README-4.md) | 远程模块加载 | `@zenstone/ts-utils/remote` |
| [`fetch-download`](_media/README-5.md) | 下载工具 | `@zenstone/ts-utils/fetch-download` |
| [`misc`](_media/README-6.md) | 杂项工具（timer、singleton、configurable 等） | `@zenstone/ts-utils/misc` |
| [`events`](_media/README-7.md) | 事件发布订阅 | `@zenstone/ts-utils/events` |

## 模块详情

### [`async`](_media/README.md)
...
### [`fetch-download`](_media/README-5.md)
...
### [`misc`](_media/README-6.md)

杂项工具（timer、singleton、configurable 等）

**Functions:**

- [`clearTicker`](_media/clearTicker.md)
- [`clearTimer`](_media/clearTimer.md)
- [`cloneObj`](_media/cloneObj.md)
- [`configurable`](_media/configurable.md)
- [`singleton`](_media/singleton.md)
- [`ticker`](_media/ticker.md)
- [`timer`](_media/timer.md)

### [`events`](_media/README-7.md)

事件发布订阅

**Functions:**

- [`createDelegator`](_media/createDelegator.md)
- [`createEmitter`](_media/createEmitter.md)
- [`initEventsEmitter`](_media/initEventsEmitter.md)
- [`isEventsDelegator`](_media/isEventsDelegator.md)
- [`isEventsEmitter`](_media/isEventsEmitter.md)
- [`linkEvents`](_media/linkEvents.md)
