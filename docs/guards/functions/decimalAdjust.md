...
[@zenstone/ts-utils](../../modules.md) / [guards](../README.md) / decimalAdjust

# Function: decimalAdjust()

> **decimalAdjust**(`type`, `value`, `exp?`): `number`

Defined in: [src/guards/index.ts:120](https://github.com/janpoem/ts-utils/blob/a6181273044ad30164507cc181a58cccd8e952df/src/guards/index.ts#L120)
